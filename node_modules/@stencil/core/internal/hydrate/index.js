...
const callRender = (e, t, o, n) => {
 ...
 })), s.length > 0 && (f && (d.innerHTML += SLOT_FB_CSS), BUILD.invisiblePrehydration && (BUILD.hydratedClass || BUILD.hydratedAttribute) && (d.innerHTML += s + "{visibility:hidden}.hydrated{visibility:inherit}"), 
 d.innerHTML.length)) {
