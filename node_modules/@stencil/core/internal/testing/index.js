...
exports.addHostEventListeners = addHostEventListeners, exports.bootstrapLazy = (e, t = {}) => {
 ...
 })), s.length > 0 && (m && (p.innerHTML += SLOT_FB_CSS), appData.BUILD.invisiblePrehydration && (appData.BUILD.hydratedClass || appData.BUILD.hydratedAttribute) && (p.innerHTML += s + "{visibility:hidden}.hydrated{visibility:inherit}"), 
 p.innerHTML.length)) {
